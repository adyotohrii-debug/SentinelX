import { Activity, FileText, History, Home, LayoutDashboard, ScanSearch, Settings2, ShieldCheck, Shield } from "lucide-react";
...
export default function Sidebar() {
  return (
    <aside className="app-sidebar">
      <NavLink to="/" className="brand" title="Return to Landing Page">
      ...
      <div className="sidebar-health">
        <span><Activity size={15} /> Platform status</span>
        <strong><i /> Operational</strong>
        <small>8 security modules online</small>
      </div>
    </aside>
  );
}
